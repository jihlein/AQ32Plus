...
void adcInit(void)
{
  ...
  //ADC_InitStructure.ADC_DataAlign            = ADC_DataAlign_Right;
    ...
    ADC_RegularChannelConfig(ADC1, ADC1_CHANNEL,  8,  ADC_SampleTime_480Cycles);
...
float aglRead(void)
{
    return constrain(adcValue(1) * VOLTS_PER_BIT * AGL_SCALE_FACTOR, 0.0f, 7.0f);
}
