...
#define ADC_PIN_4      ADC_PIN_4_CONVERTED_VALUE
#define ADC_PIN_5      ADC_PIN_5_CONVERTED_VALUE
#define ADC_PIN_6      ADC_PIN_6_CONVERTED_VALUE
#define ADC_PIN_VBATT  VBATT_CONVERTED_VALUE
